...
public class TblClimateScenarioMonth {
	...
	public TblClimateScenarioMonth(String fldWatershedCode, String fldCountyCode, String fldCRPType,
	...
	public String toString() {
		return "TblClimateScenarioYear [id=" + id + ", fldWatershedCode=" + fldWatershedCode + ", fldCountyCode="
				+ fldCountyCode + ", fldCRPType=" + fldCRPType + ", fldDate=" + fldDate + ", fldPrecipitation="
				+ fldPrecipitation + ", fldAvgTemperature=" + fldAvgTemperature + ", fldMaxTemp=" + fldMaxTemp
				+ ", fldMinTemp=" + fldMinTemp + "]";
	}
