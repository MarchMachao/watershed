...
public class ResourceController extends BaseController {
	...
	public DataGrideRow<Resource> getMyResource(@RequestParam(defaultValue = "1") Integer page, Integer rows,
		...
		return new DataGrideRow<Resource>(resourceService.countMyResource(name, type),
				resourceService.getMyResource(page, rows, type, name));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "getMyResourceById", method = RequestMethod.GET)
	@ResponseBody
	public DataGrideRow<Resource> getMyResourceById(String id) {
		logger.info("successful");
		return new DataGrideRow<Resource>(1, resourceService.getResourceById(id));
	}
