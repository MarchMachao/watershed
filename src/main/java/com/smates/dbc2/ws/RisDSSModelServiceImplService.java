 ...
 * 2016-11-24T11:02:35.814+08:00
 * Generated source version: 3.1.8
 * 
 */
@WebServiceClient(name = "RisDSSModelServiceImplService", 
                  wsdlLocation = "http://210.77.67.251/Webservice-Demo/RisDSSModelServiceWS?wsdl",
...
public class RisDSSModelServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://210.77.67.251/Webservice-Demo/RisDSSModelServiceWS?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RisDSSModelServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://210.77.67.251/Webservice-Demo/RisDSSModelServiceWS?wsdl");
        }
        WSDL_LOCATION = url;
    }
