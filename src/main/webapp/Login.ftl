		...
		<div id="loginbox">
					...
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg">
								...
								<input type="text" name="accountNumber" id="loginname" value="" placeholder="请输入用户名" />
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<input type="password" name="userpwd" id="password" placeholder="请输入密码" value="" />
						</div>
						<div class="danger-error">${callback}</div>
					</div>
				</div>
				<div class="form-actions">
					<div style="width: 86%; padding-left: 8%;">
						...
						<span class="pull-right">
							<input type="submit" class="flip-link btn btn-info" id="to-recover" value="登录"></button>
						</span>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white">
						<span id="nameerr">
							Copyright © 2015 中国科学院寒区旱区环境与工程研究所
						</span>
					</font>
				</div>
			</div>
