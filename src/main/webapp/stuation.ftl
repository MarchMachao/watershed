...
<body>
			...
			<div class="row-fluid">
				<div class="tabbable">
					<ul class="nav nav-tabs" id="situation">
						<li class="active"><a data-toggle="tab" href="#climate"><i
								class="pink icon-dashboard bigger-110"></i>气候情景</a></li>
						<li><a data-toggle="tab" href="#industry"><i
								class="blue icon-user bigger-110"></i>产业与城市发展情景</a></li>
						<li><a data-toggle="tab" href="#economy"><span
								class="badge badge-success badge-icon"><i
									class="icon-caret-right"></i></span>社会经济发展情景</a></li>
						<li><a data-toggle="tab" href="#land"><i
								class="blue icon-user bigger-110"></i>土地利用情景</a></li>
						<li><a data-toggle="tab" href="#water"><span
								class="badge badge-success badge-icon"><i
									class="icon-caret-right"></i></span>水资源管理情景</a></li>
					...
					<div class="tab-content">
						...
						<div id="climate" class="tab-pane in active">
							...
							<div class="row-fluid">
								<div class="span2"></div>
								<label style="margin-top: 10px;"> <span>选择区县</span> <select
									id="IPCC-selectCounty">
								...
								<div class="span10">
									<h4 class="header smaller lighter blue">
										<i class="icon-certificate"></i> <span>选择气候情景(IPCC)</span>
									</h4>
								</div>
								<div class="span1"></div>
							</div>
							...
							<div class="row-fluid">
								<div class="span2"></div>
								<div class="span6">
									<label> <span>选择气候情景(IPCC)</span> <select id="IPCC"
										name="IPCC" style="margin: 0px">
							...
							<div class="row-fluid">
								<div class="span6" id="showArea-1"
									style="text-align: right; height: 300px">
									<!-- ECharts图表显示 -->
								</div>
								<div class="span6" id="showArea-2"
							...
							<div class="row-fluid">
								...
								<div class="span10">
									<h4 class="header smaller lighter blue">
										<i class="icon-bolt"></i> <span>降雨、温度增加比例</span>
									</h4>
								</div>
								<div class="span1"></div>
							</div>
							...
							<div class="row-fluid">
								<div class="span2"></div>
								<div class="span2">
									<label> <span>降雨增加比例</span>
									</label>
								</div>
								<div class="span6">
									<div id="slider-1-1" style="float: left; display: inline;"></div>
								</div>
								<div class="span2">
									<input type="text" class="input-mini" id="rain_inc_ratio"
										value="2" />%
								</div>
							</div>
							...
							<div class="row-fluid">
								<div class="span2"></div>
								<div class="span2">
									<label> <span>温度增加比例</span>
									</label>
								</div>
								<div class="span6">
									<div id="slider-1-2" style="float: left; display: inline;"></div>
								</div>
								<div class="span2">
									<input type="text" class="input-mini" id="temp_inc_ratio"
										value="2" />%
								</div>
							</div>
							...
							<div class="form-actions" align="center">
								...
								<button class="btn btn-small btn-success" type="button"
									id="climate_submit">确定</button>
								&nbsp;
								<button class="btn btn-small btn-warning" type="reset"
									id="climate_reset">重置</button>
							</div>
						</div>
								...
								<div class="span10">
									<div class="row-fluid" id="population_proportation">
										...
										<div>
											<div class="span1"></div>
											<div class="span10">
												非农业人口比例： <input type="text" class="input-mini"
													id="population_proportation_spinner" />%
											</div>
										</div>
										<div class="row-fluid">
											<div class="span12" id="showArea-3"
									...
									<div>
										...
										<div>
											<div>
												<div class="span9"></div>
												<div class="span1">产值比例</div>
												<div class="span2">产值</div>
											</div>
											<div>
												<div>
													<div class="span1"></div>
													<div class="span1">工业</div>
													<div class="span7">
														<div id="slider-1" style="float: left; display: inline;"></div>
													</div>
													<div class=span3>
														<input type="text" id="situation-1" value="26.8"
															style="width: 40px; height: 20px">% <input
															type="text" id="situation-1-2" value="33.17"
															style="width: 60px; height: 20px">亿元
													</div>
												</div>
												<div>
													<div class="span1"></div>
													<div class="span1">农业</div>
													<div class="span7">
														<div id="slider-2" style="float: left; display: inline;"></div>
													</div>
													<div class=span3>
														<input type="text" id="situation-2" value="29.4"
															style="width: 40px; height: 20px">% <input
															type="text" id="situation-2-2" value="36.4"
															style="width: 60px; height: 20px">亿元
													</div>
												</div>
												<div>
													<div class="span1"></div>
													<div class="span1">服务业</div>
													<div class="span7">
														<div id="slider-3" style="float: left; display: inline;"></div>
													</div>
													<div class=span3>
														<input type="text" id="situation-3" value="43.8"
															style="width: 40px; height: 20px">% <input
															type="text" id="situation-3-2" value="54.24"
															style="width: 60px; height: 20px">亿元
													</div>
												</div>
											</div>
											<div class="row-fluid">
												<div class="span12" id="showArea-4"
													style="height: 300px; width: 800px">
													<!-- ECharts图表显示 -->
												</div>
											</div>
									...
									<div>
										...
										<div>
											<div class="span1"></div>
											<div class="span2">产业进步率</div>
											<div class="span7">
												<div id="slider-4" style="float: left; display: inline;"></div>
											</div>
											<div class="span2">
												<input type="text" id="situation-4" value="1"
													style="width: 40px; height: 20px">%
											</div>
										</div>
										<p align="center">
											<span class="red">*科技进步，包括设备改进，方法创新与改进等引起的产业与产值的变化</span>
										</p>
									</div>
									<hr style="height: 1px" color="#c2daee">
									<div>
										...
										<div>
											<div class="span1"></div>
											<div class="span2">旅游业产值变化率</div>
											<div class="span7">
												<div id="slider-5" style="float: right; display: inline;"></div>
											</div>
											<div class="span2">
												<input type="text" id="situation-5" value="5"
													style="width: 40px; height: 20px">%
											</div>
										</div>
									</div>
						...
						<div id="economy" class="tab-pane">
							<div class="row-fluid">
								...
								<div class="span10">
									...
									<h4 class="header smaller lighter blue">
										<span class="lbl"><i class="icon-credit-card"></i>
											人均GDP增长率</span>
									</h4>
								</div>
								<div class="span1"></div>
							...
							<div class="row-fluid">
								<div class="span2"></div>
								<div class="span8">
									<span>人均GDP增长率</span> <input type="text" class="input"
										id="GDPInc_spinner1" />%
								</div>
							...
							<div class="row-fluid">
								<div class="span2"></div>
								<div class="span8">
									<label> <input name="population_policy" type="radio" />
										<span class="lbl"> 一胎</span> <input name="population_policy"
										type="radio" /> <span class="lbl"> 两胎</span> <input
										name="population_policy" type="radio" /> <span class="lbl">
											全面放开</span>
									</label>
								</div>
								<div class="span2"></div>
							...
							<div class="row-fluid">
								...
								<div class="span8">
									...
									<div class="row-fluid">
										...
										<div class="span4">
											<span>943.08(km)</span> <span
												style="margin-bottom: 8px; margin-top: 0px; float: right">
									...
									<div class="row-fluid">
										...
										<div class="span4">
											<span>1033.63(km)</span> <span style="float: right"> <input
												type="text" class="input" id="zhiQu_spinner" />%
											</span>
										</div>
									...
									<div class="row-fluid">
										...
										<div class="span4">
											...
											<span>2318.42(km)</span> <span style="float: right"> <input
												type="text" class="input" id="douQu_spinner" />%
											</span>
									...
									<div class="row-fluid">
										...
										<div class="span4">
											<span>2.42(km)</span> <span style="float: right"> <input
												type="text" class="input" id="nongQu_spinner" />%
											</span>
										</div>
									...
									<div class="row-fluid">
										...
										<div class="span4">
											<span>0(km)</span> <span style="float: right"> <input
												type="text" class="input" id="maoQu_spinner" />%
											</span>
										</div>
							...
							<div class="row-fluid">
								...
								<div class="span8">
									<div class="row-fluid">
										...
										<div class="span8">
											<div id="economy-slider-1"
												style="float: right; display: inline;"></div>
										</div>
										<div class="span2">
											<input type="text" id="economy-diGuanArea" class="input-mini"
												value="50">万亩
										</div>
									</div>
								</div>
							...
							<div class="row-fluid">
								...
								<div class="span10">
									<div class="row-fluid" id="area_rateofchange">
										...
										<h4 class="header smaller lighter blue">
											<i class="icon-credit-card"></i>耕地面积变化
										</h4>
										<div>
											<div class="span1"></div>
											<div class="span5" style="text-align: center">
												耕地面积变化率： <input type="text" class="input-mini"
													id="area_rateofchange_spinner" />%
											</div>
											<!--<div class="span5" style="text-align:center">
													选择县区
										...
										<div class="row-fluid">
											<div class="span12" id="land_show_1"
												style="height: 300px; width: 800px">
												<!-- ECharts图表显示 -->
											</div>
										</div>
									...
									<div>
										...
										<div>
											...
											<div>
												<div>
													...
													<div class="span6">
														<div id="land_slider_1"
															style="float: left; display: inline;"></div>
													</div>
													<div class=span4>
														<input type="text" id="land_situation_1" value="0"
															style="width: 40px; height: 20px">%&nbsp&nbsp&nbsp&nbsp
														<input type="text" id="land_situation_1_2" value="0"
															style="width: 60px; height: 20px">万亩
													</div>
												</div>
												<div>
													<div class="span1"></div>
													...
													<div class="span6">
														<div id="land_slider_2"
															style="float: left; display: inline;"></div>
													</div>
													<div class=span4>
														<input type="text" id="land_situation_2" value="0"
															style="width: 40px; height: 20px">%&nbsp&nbsp&nbsp&nbsp
														<input type="text" id="land_situation_2_2" value="0"
															style="width: 60px; height: 20px">万亩
													</div>
												</div>
												<div>
													...
													<div class="span6">
														<div id="land_slider_3"
															style="float: left; display: inline;"></div>
													</div>
													<div class=span4>
														<input type="text" id="land_situation_3" value="0"
															style="width: 40px; height: 20px">%&nbsp&nbsp&nbsp&nbsp
														<input type="text" id="land_situation_3_2" value="0"
															style="width: 60px; height: 20px">万亩
													</div>
												</div>
											</div>
											<div>
												...
												<div class="span6">
													<div id="land_slider_4"
														style="float: left; display: inline;"></div>
												</div>
												<div class=span4>
													<input type="text" id="land_situation_4" value="0"
														style="width: 40px; height: 20px">%&nbsp&nbsp&nbsp&nbsp
													<input type="text" id="land_situation_4_2" value="0"
														style="width: 60px; height: 20px">万亩
												</div>
											</div>
										</div>
										<div>
											...
											<div class="span6">
												<div id="land_slider_5"
													style="float: left; display: inline;"></div>
											</div>
											<div class=span4>
												<input type="text" id="land_situation_5" value="0"
													style="width: 40px; height: 20px">%&nbsp&nbsp&nbsp&nbsp
												<input type="text" id="land_situation_5_2" value="0"
													style="width: 60px; height: 20px">万亩
											</div>
										</div>
										...
										<div>
											...
											<div class="span6">
												<div id="land_slider_6"
													style="float: left; display: inline;"></div>
											</div>
											<div class=span4>
												<input type="text" id="land_situation_6" value="0"
													style="width: 40px; height: 20px">%&nbsp&nbsp&nbsp&nbsp
												<input type="text" id="land_situation_6_2" value="0"
													style="width: 60px; height: 20px">万亩
											</div>
										</div>
									</div>
									...
									<div class="row-fluid">
										<div class="span12" id="land_show_2"
											style="height: 300px; width: 800px">
											<!-- ECharts图表显示 -->
										</div>
									</div>
						...
						<div id="water" class="tab-pane">
							<div class="span1"></div>
							<div class="span10">
								<form class="form-horizontal" id="form_water" name="form_water"
									action="#" method="post">
									<fieldset>
										<h4 class="header smaller lighter blue">
											<i class="icon-exchange"></i>流域中下游水分配
										</h4>

										<div class="row-fluid" style="margin-top: 15px">
											<div class="span3" style="text-align: center">
												<span class="lbl">可供地表水</span> <input type="text"
													class="input" id="water_province_total" /> <span
													class="lbl">万m^3</span>
											</div>
											<div class="span1"></div>
											<div class="span3">
												<span class="lbl">中游</span> <input type="text"
													id="water_province_1" style="width: 60px; height: 28px"
													value="7940" />
												<!-- 设置该文本框显示的初始值 -->
											...
											<div class="span2"></div>
											<div class="span3">
												<span class="lbl">下游</span> <input type="text"
													id="water_province_2" style="width: 60px; height: 28px"
													value="7940" />
												<!-- 设置该文本框显示的初始值 -->
												<span class="lbl">万m^3</span>
											</div>
										...
										<div class="row-fluid" style="margin-top: 15px">
											...
											<div class="span1"></div>
											<div class="span3">
												<span class="lbl">中游</span> <input type="text" class="input"
													id="water_province_ratio_1"
													style="width: 60px; height: 28px" value="50" />
												<!-- 设置该文本框显示的初始值 -->
												<span class="lbl">%</span>
											</div>
											<div class="span2"></div>
											<div class="span3">
												<span class="lbl">下游</span> <input type="text" class="input"
													id="water_province_ratio_2"
													style="width: 60px; height: 28px" value="50" />
												<!-- 设置该文本框显示的初始值 -->
												<span class="lbl">%</span>
											</div>
										...
										<div class="row-fluid">
											<div class="span12" id="using-water"
												style="height: 300px; width: 800px">
												<!-- ECharts图表显示 -->
											</div>
										</div>
										<hr style="height: 1px" color="#c2daee">
										<h4 class="header smaller lighter blue">
											<i class="icon-exchange"></i>水权分配
										</h4>

										<div class="row-fluid">
											<div class="span1"></div>
											<div class="span9">
												选择地区： <select id="selectToCounty">
										...
										<div id="dropdown1" class="row-fluid">
											...
											<div class="row-fluid" style="margin-top: 15px">
												<div class="span3" style="text-align: center">
													<span class="lbl">总可用水量</span> <input type="text"
														class="input" id="water_county_total" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution1"
														style="width: 60px; height: 28px" value="11400" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution2"
														style="width: 60px; height: 28px" value="600" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution3"
														style="width: 60px; height: 28px" value="0" /> <span
														class="lbl">万m^3</span>
												</div>
											</div>
										</div>
											...
											<div class="row-fluid" style="margin-top: 15px">
												...
												<div class="span2">
													<input type="text" class="input"
														id="water_county_ratio_2_1" /> <span class="lbl">%</span>
												</div>
												<div class="span2">
													<input type="text" class="input"
														id="water_county_ratio_2_2" /> <span class="lbl">%</span>
												</div>
												<div class="span2">
													<input type="text" class="input"
														id="water_county_ratio_2_3" /> <span class="lbl">%</span>
												</div>
												<div class="span2">
													<input type="text" class="input"
														id="water_county_ratio_2_4" /> <span class="lbl">%</span>
												</div>
											</div>
											<div class="row-fluid" style="margin-top: 15px">
												<div class="span3" style="text-align: center">
													<span class="lbl">总可用水量</span> <input type="text"
														class="input" id="water_county_total2" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution2_1"
														style="width: 60px; height: 28px" value="11400" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution2_2"
														style="width: 60px; height: 28px" value="600" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution2_3"
														style="width: 60px; height: 28px" value="0" /> <span
														class="lbl">万m^3</span>
												</div>
												<div class="span2">
													<input type="text" id="water_county_distribution2_4"
														style="width: 60px; height: 28px" value="0" /> <span
														class="lbl">万m^3</span>
												</div>
											</div>
										...
										<div class="row-fluid">
											...
											<div class="row-fluid">
												<div class="span1"></div>
												<div class="span9">
													选择县区： <select id="technology-selectCounty">
														<option value="620702">甘州</option>
														<option value="620723">临泽</option>
														<option value="620724">高台</option>
														<option value="152923">额济纳旗</option>
											...
											<div class="row-fluid" style="margin-top: 20px">
												...
												<div class="span7">
													<div id="slider-water-saving"
														style="float: left; display: inline;"></div>
												</div>
												<div class="span2">
													<input type="text" id="water-saving" value="10"
														style="width: 40px; height: 20px">%
												</div>
											</div>
											<div class="span12">
												<p align="center">
													<span class="red">*节水技术，包括水利工程改善、节水方式改善</span>
												</p>
											</div>
										</div>
	...
	<script type="text/javascript">
		...
		function showFigure_1() {
			$
					.get(
							"geTblClimateScenarioYearsByfldCRPType.do",
							{
								fldCRPType : $("#IPCC").val()
							},
							function(data) {
								...
								if (data.length >= 1) {
									var titletext = data[0].fldDate + '~'
											+ data[data.length - 1].fldDate
											+ '年温度变化';
								}
								var Chart = echarts.init(document
										.getElementById('showArea-1'));
								var option = {
									title : {
										text : titletext,
										x : 'center',
			...
			$.get("geTblClimateScenarioYearsByfldCRPType.do", {
				fldCRPType : $("#IPCC").val()
					...
					function(data) {
						...
						if (data.length >= 1) {
							var titletext = data[0].fldDate + '~'
									+ data[data.length - 1].fldDate + '年降水变化';
						}
						var Chart = echarts.init(document
								.getElementById('showArea-2'));
						var option = {
							title : {
								text : titletext,
								x : 'center',
			...
			$.get('getTblIndustyUrbanSceByfldCountyCode.do', {
				fldCountyCode : $("#industry-selectCounty").val()
					...
					function(data) {
						...
						if (data.length >= 1) {
							var titletext = data[0].fldDate + '~'
									+ data[data.length - 1].fldDate + '人口比例变化';
						}
						var Chart = echarts.init(document
								.getElementById('showArea-3'));
						var option = {
							title : {
								text : titletext,
								x : 'center',
		...
		function showFigure_4() {
			$
					.get(
							'getTblIndustyUrbanSceByfldCountyCode.do',
							{
								fldCountyCode : $("#industry-selectCounty")
										.val()
							},
							function(data) {
		...
		function showFigure_5() {
			$.get('getTblSocioEconSceByfldCountyCode.do', {
				...
				if (data.length >= 1) {
					var titletext = data[0].fldDate + '~'
							+ data[data.length - 1].fldDate + '年人均GDP变化';
				}
				var Chart = echarts.init(document
						.getElementById('economy-showArea-1'));
				var option = {
					title : {
						text : titletext,
						x : 'center',
		...
		function showFigure_6() {
			$
					.get(
							'getTblHydrEngineeringByfldCountyCode.do',
							{
								fldCountyCode : $("#water-selectCounty").val()
							},
							function(data) {
								...
								var Chart = echarts.init(document
										.getElementById('economy-showArea-2'));
								var option = {
									title : {
										text : titletext,
										x : 'center',
		...
		function land_show_1() {
			$
					.get(
							'getTblLandUseSceByfldCountyCode.do',
							{
							...
							function(data) {
								...
								if (data.length >= 1) {
									var titletext = data[0].fldDate
											...
											+ data[data.length - 1].fldDate
											+ '年'
											+ $("#land_selectCounty").find(
													"option:selected").text()
											+ '耕地面积变化';
								}
								var Chart = echarts.init(document
										.getElementById('land_show_1'));
								var option = {
									title : {
										text : titletext,
										x : 'center',
			...
			$.get('getTblCropPatternByfldCountyCode.do', {
				...
				if (data.length >= 1) {
					var titletext = data[0].fldDate
							...
							+ data[data.length - 1].fldDate
							+ '年'
							+ $("#land_selectCounty").find("option:selected")
									.text() + '不同作物种植面积变化';
				}
				var Chart = echarts
						.init(document.getElementById('land_show_2'));
				var option = {
					title : {
						text : titletext,
						x : 'center',
		...
		function showArea_usingng_water() {
			$.get('getTblMidDownWaterAllo.do', [], function(data) {
				...
				if (data.length >= 1) {
					var titletext = data[0].fldDate + '~'
							+ data[data.length - 1].fldDate + '年流域中游与下游用水量变化';
				}
				var Chart = echarts
						.init(document.getElementById('using-water'));
				var option = {
					title : {
						text : titletext,
						x : 'center',
